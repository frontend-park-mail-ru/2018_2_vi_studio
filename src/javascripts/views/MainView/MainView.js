...
const USER_NAV_ITEMS = [
    {title: 'Game Online', href: '/game/online'},
    {title: 'Game Offline', href: '/game/offline'},
    {title: 'Home', href: '/'},
...
export default class MenuView extends View {
    ...
    renderLeaders(page = 1) {
        LeaderModel.getAll(page).then(leaders => {
                ...
                if (page == 1) {
                    Component.render([new Leaderboard({leaders: leaders}), next], this.content);
                } else {
                    Component.render([new Leaderboard({leaders: leaders}), prev, next], this.content);
                }
